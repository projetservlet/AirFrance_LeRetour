...
`ville_idVille`)
VALUES
("A�roport international de New York-John F. Kennedy",
"JFK",
"4");
...
`ville_idVille`)
VALUES
("A�roport de New York-LaGuardia",
"LGA",
"4");
...
`ville_idVille`)
VALUES
("A�roport international de Los Angeles",
"LAX",
"5");
...
`ville_idVille`)
VALUES
("A�roport international de Boston-Logan",
"BOS",
"6");
