...
public class SignupServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!m.matches()) {
			...
			request.setAttribute("errorMessagepassword",
					"Mot de passe incorrect : doit contenir au moin une majuscule, une miniscule et un chiffre");
		}
		...
		if (!email.equals(confirmEmail)) {
			ClientCanBeCreated = false;
			request.setAttribute("errorMessageconfirmEmail", "vous avez rentré deux emails différents");
		}
